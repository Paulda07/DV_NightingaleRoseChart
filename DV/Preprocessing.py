...
class Preprocessing:
	...
	def __init__(self):
		...
		sqlEngine = create_engine('mysql+pymysql://root:MyNewPass@127.0.0.1/crime_data', pool_recycle=3600)
	...
	def dataset_read(self, year1, year2):
		...
		sql_query = f'select * from crime_dataset_test where year(CrimeDateTime) between {year1} and {year2}'
